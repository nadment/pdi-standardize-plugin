 ...
 *
 */
@Step(id = "StandardizeUrl", image = "standardizeurl.svg", i18nPackageName = "org.kettle.trans.steps.standardize", name = "StandardizeUrl.Name", description = "StandardizeUrl.Description", categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.DataQuality", documentationUrl = "https://github.com/nadment/pdi-standardize-plugin/wiki")
