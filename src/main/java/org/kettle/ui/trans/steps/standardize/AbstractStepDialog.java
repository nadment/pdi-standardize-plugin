package org.kettle.ui.trans.steps.standardize;
 ...
 * @param <StepMetaType>
 */
public abstract class AbstractStepDialog<StepMetaType extends StepMetaInterface> extends BaseStepDialog
  ...
  public StepMetaType getStepMeta() {
    return (StepMetaType) this.baseStepMeta;
  }
...
//    wOK.setLayoutData(new FormDataBuilder().bottom().right(wCancel, -ConstUI.SMALL_MARGIN).width(BUTTON_WIDTH).result());
  ...
  public Image getImage() {
    ...
    if (plugin.getImageFile() != null) {
      return SwtSvgImageUtil.getImage(shell.getDisplay(), getClass().getClassLoader(), plugin.getImageFile(),ConstUI.ICON_SIZE, ConstUI.ICON_SIZE); 
// TODO:           ConstUI.LARG_ICON_SIZE, ConstUI.LARGE_ICON_SIZE);
    }
   ...
   */
  protected abstract void loadMeta(final StepMetaType stepMeta);
   ...
   */
  protected abstract void saveMeta(final StepMetaType stepMeta);
